...
import org.wildfly.core.management.annotation.ResourceOperation;
...
import static org.wildfly.core.management.processor.AnnotationUtils.annotationIs;
import static org.wildfly.core.management.processor.AnnotationUtils.booleanValue;
import static org.wildfly.core.management.processor.AnnotationUtils.classArrayValue;
import static org.wildfly.core.management.processor.AnnotationUtils.classValue;
import static org.wildfly.core.management.processor.AnnotationUtils.enumConstValue;
import static org.wildfly.core.management.processor.AnnotationUtils.getAnnotation;
import static org.wildfly.core.management.processor.AnnotationUtils.getAnnotationValue;
import static org.wildfly.core.management.processor.AnnotationUtils.getAnnotationValueEnumConst;
import static org.wildfly.core.management.processor.AnnotationUtils.getAnnotationValueString;
import static org.wildfly.core.management.processor.AnnotationUtils.stringArrayValue;
import static org.wildfly.core.management.processor.AnnotationUtils.stringValue;
import static org.wildfly.core.management.processor.NameUtils.buildNamespace;
import static org.wildfly.core.management.processor.NameUtils.constify;
import static org.wildfly.core.management.processor.GeneratorUtils.def;
import static org.wildfly.core.management.processor.NameUtils.namespaceify;
import static org.wildfly.core.management.processor.NameUtils.singular;
import static org.wildfly.core.management.processor.NameUtils.without;
import static org.wildfly.core.management.processor.NameUtils.xmlify;
...
final class ProcessingContext {
    ...
    private static Set<String> skipMemberClassNames = new HashSet<String>(Arrays.asList(Object.class.getName(), Node.class.getName()));
    ...
    private AttributeValueInfo processNewAttributeValue(String name, ExecutableElement declaringElement) {
        ...
        for (AnnotationMirror annotationMirror : declaringElement.getAnnotationMirrors()) {
            if (annotationIs(annotationMirror, Enumerated.class)) {
                ...
                final boolean list;
                if (isSameType(ResourceLink.class, type)) {
                    ...
                    if (! isSameType(ResourceLink.class, typeMirror)) {
        ...
        if (declaringElement.getAnnotation(AttributeGroup.class) != null) {
            if (isAssignable(type, Node.class)) {
    ...
    private AttributeGroupInfo processNewAttributeGroup(final TypeElement typeElement) {
        ...
        try {
            ...
            if (typeElement.getSimpleName().toString().endsWith("Resource") || isAssignable(typeElement.asType(), Node.class)) {
